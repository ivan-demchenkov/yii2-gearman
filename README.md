...
{
    "require": {
       "totaldev/yii2-gearman": "dev-master"
    }
}
```
...
'components' => [
  'gearman' => [
      'class' => 'totaldev\yii2\gearman\GearmanComponent',
      'servers' => [
...
'controllerMap' => [
    'gearman' => [
        'class' => 'totaldev\yii2\gearman\GearmanController',
...
use totaldev\yii2-gearman\JobBase;
